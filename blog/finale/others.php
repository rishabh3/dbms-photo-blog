<html>
<head><title>NSB Generic page</title></head>
...
.parallax {
    /* The image used */
    background-image: url('othbg.png');
...
<table class="gen" cellpadding="15px">
	<tr><td>
	<div class="login">
...
<td><a href="household.php" style="text-decoration: none;"><h3 style="color:green;font-size:25px;">
Household Waste</h3> Let's clean up garbage in the whole country, starting from our Capital!</a></td>
</tr>
</table>
